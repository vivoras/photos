...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    /** @return {string} */
    davPath() {
      return (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_2__.generateRemoteUrl)(`dav/files/${(0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_3__.getCurrentUser)().uid}`) + this.item.filename;
    },
  ...
  methods: {
    ...
    getItemURL(size) {
      return (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_2__.generateUrl)(`/core/preview?fileId=${this.item.fileid}&c=${this.decodedEtag}&x=${size}&y=${size}&forceIcon=0&a=1`);
    },
...
//# sourceMappingURL=photos-src_services_DavRequest_js-src_components_File_vue.js.map?v=dc4125651822b15cf182